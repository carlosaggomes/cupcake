...
var app = new Framework7({
  ...
  serviceWorker: {
    path: '/cupcake/service-worker.js',
  },
});
...
$('#my-login-screen .login-button').on('click', function () {
  ...
  app.request.post("https://profcarlosgomes.com.br/cupcake/backend/login.php", { usuario:username, senha: password })
    .then(function (res) {
...
function ListarCardapio(tipo = "proprietario") {
  ...
  xmlhttp.onload = function() {
    ...
    for(var item in objCardapio.itens) {
      ...
      it = it + '>  <div class="item-media"><img src="https://profcarlosgomes.com.br/cupcake/backend/' + objCardapio.itens[item].foto + '"'
      it = it + '      width="80" /></div>'
  ...
  xmlhttp.open("GET", "https://profcarlosgomes.com.br/cupcake/backend/cardapio_lista.php?empresa=" + usuario.id);
  xmlhttp.send();   
}
...
function ListarEmpresa() {
  ...
  xmlhttp.onload = function() {
    ...
    for(var item in objEmpresa.empresas) {
      ...
      it = it + '>  <div class="item-media"><img src="https://profcarlosgomes.com.br/cupcake/backend/' + objEmpresa.empresas[item].foto + '"'
      it = it + '      width="80" /></div>'
      it = it + '  <div class="item-inner">'
      it = it + '    <div class="item-title-row">'
  ...
  xmlhttp.open("GET", "https://profcarlosgomes.com.br/cupcake/backend/empresa_lista.php");
  xmlhttp.send();   
}
  ...
  app.dialog.confirm('Confirma o envio do cadastro?', function () {
    ...
    if(senha == senha2) {
      ...
      */
      ...
      xmlhttp.open("POST", "https://profcarlosgomes.com.br/cupcake/backend/cadastro.php?nome=" + nome + "&descricao=" + descricao +
...
function GravarDados() {
  app.dialog.confirm('Confirma o cadastro do item?', function () {
    ...
    app.request({
      url: "https://profcarlosgomes.com.br/cupcake/backend/cardapio.php", 
      method: 'POST',
